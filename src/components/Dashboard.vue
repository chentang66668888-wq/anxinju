...
body {
    background: linear-gradient(145deg, #0a0f1e 0%, #0c1222 50%, #0f1528 100%);
...
.glass-card {
    ...
    box-shadow: 0 20px 40px rgba(0, 0, 0, 0.4), 0 0 20px rgba(59, 110, 255, 0.1);
...
.glass-card:hover {
    border-color: rgba(72, 120, 255, 0.5);
    box-shadow: 0 25px 50px rgba(0, 0, 0, 0.5), 0 0 30px rgba(59, 110, 255, 0.15);
...
.stat-card:hover {
    ...
    box-shadow: 0 12px 24px rgba(59, 110, 255, 0.2);
}
.stat-title {
    font-size: 0.95rem;
    font-weight: 600;
...
.user-card {
    ...
    flex-direction: column;
    gap: 24px;
    background: linear-gradient(135deg, rgba(78, 205, 196, 0.1), rgba(59, 110, 255, 0.1));
...
.btn-outline:hover {
    background: linear-gradient(135deg, rgba(72, 120, 255, 0.3), rgba(139, 92, 246, 0.3));
    border-color: rgba(72, 120, 255, 0.6);
    transform: translateY(-2px);
    box-shadow: 0 8px 16px rgba(59, 110, 255, 0.2);
}
...
.status-bar {
    ...
    align-items: center;
    font-size: 0.85rem;
    background: linear-gradient(135deg, rgba(8, 14, 26, 0.9), rgba(18, 25, 45, 0.9));
